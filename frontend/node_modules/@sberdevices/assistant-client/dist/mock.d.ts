...
export declare const createAssistantHostMock: ({ context }?: {
    ...
    receiveCommand: <T_1 extends AssistantSmartAppData>(command: AssistantClientCustomizedCommand<T_1>) => Promise<unknown>;
...
export declare const createAssistantHostMockWithRecord: ({ context, record, }: {
    ...
    receiveCommand: <T extends AssistantSmartAppData>(command: AssistantClientCustomizedCommand<T>) => Promise<unknown>;
};
