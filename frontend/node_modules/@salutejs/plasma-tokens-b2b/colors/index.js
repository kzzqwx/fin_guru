...
exports.inputBorder = 'var(--plasma-colors-input-border, rgba(8, 8, 8, 0.28))';
exports.inputBorderHover = 'var(--plasma-colors-input-border-hover, rgba(8, 8, 8, 0.56))';
exports.inputBorderFocus = 'var(--plasma-colors-input-border-focus, #2A72F8)';
/** Акцентный цвет бренда */
exports.accent = 'var(--plasma-colors-accent, #2A72F8)';
/** Обозначение успешного сценария */
exports.success = 'var(--plasma-colors-success, #118C28)';
/** Цвет предупреждения */
exports.warning = 'var(--plasma-colors-warning, #E35502)';
/** Цвет ошибки */
exports.critical = 'var(--plasma-colors-critical, #F31B30)';
...
exports.buttonPrimaryHover = 'var(--plasma-colors-button-primary-hover, #397CF8)';
exports.buttonPrimaryActive = 'var(--plasma-colors-button-primary-active, #1B68F8)';
...
exports.buttonAccent = 'var(--plasma-colors-button-accent, #2A72F8)';
/** Кнопка для успешного сценария */
exports.buttonSuccess = 'var(--plasma-colors-button-success, #118C28)';
exports.buttonSuccessHover = 'var(--plasma-colors-button-success-hover, #3eaa4d)';
exports.buttonSuccessActive = 'var(--plasma-colors-button-success-active, #1d9233)';
/** Цвет предупреждения у контролов */
exports.buttonWarning = 'var(--plasma-colors-button-warning, #F55D05)';
exports.buttonWarningHover = 'var(--plasma-colors-button-warning-hover, #FA650F)';
exports.buttonWarningActive = 'var(--plasma-colors-button-warning-active, #E65705)';
/** Цвет ошибки у контролов */
exports.buttonCritical = 'var(--plasma-colors-button-critical, #F31B30)';
exports.buttonCriticalHover = 'var(--plasma-colors-button-critical-hover, #F42A3E)';
exports.buttonCriticalActive = 'var(--plasma-colors-button-critical-active, #F20D24)';
/** Цвет зажатого контрола */
exports.buttonChecked = 'var(--plasma-colors-button-checked, #080808)';
exports.buttonCheckedHover = 'var(--plasma-colors-button-checked-hover, #171717)';
...
exports.buttonCheckedActiveColor = 'var(--plasma-colors-button-checked-active-color, rgba(255, 255, 255, 0.6))';
