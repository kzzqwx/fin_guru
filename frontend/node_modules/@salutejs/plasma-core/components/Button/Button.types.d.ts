 ...
 * @private
 */
export interface StyledButtonProps extends ButtonViewProps, ButtonSizeProps, PinProps, FocusProps, OutlinedProps, DisabledProps, ShiftProps, ButtonIsContentProps, Pick<ButtonProps, 'square' | 'stretch' | 'blur'> {
}
/**
 * @private
 */
