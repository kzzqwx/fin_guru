...
export declare type BasicPopupBasePlacement = 'center' | 'top' | 'bottom' | 'right' | 'left';
export declare type MixedPopupBasePlacement = 'top-right' | 'top-left' | 'bottom-right' | 'bottom-left';
