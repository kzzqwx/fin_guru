 ...
 */
var TimePicker = exports.TimePicker = function TimePicker(_ref5) {
  var id = _ref5.id,
  ...
  var isFirstMounted = _react["default"].useRef(true);
  ...
  (0, _plasmaCore.useIsomorphicLayoutEffect)(function () {
    ...
    if (!isFirstMounted.current || (0, _utils.isChanged)(prevTime, [hours, minutes, seconds])) {
      onChange === null || onChange === void 0 || onChange((0, _utils.getNewDate)(value, [hours, minutes, seconds]));
    }
