...
export var config = {
  ...
  variations: {
    ...
    layout: {
      ...
      vertical: /*#__PURE__*/css(["", ":15rem;", ":0.375rem;"], notificationTokens.width, notificationTokens.padding)
    },
    size: {
      xs: /*#__PURE__*/css(["", ":0.5rem;", ":0.5rem;", ":0.375rem;", ":0rem;", ":0.125rem;", ":0.25rem;", ":0rem;", ":0.25rem;", ":0rem;"], notificationTokens.closeIconTop, notificationTokens.closeIconRight, notificationTokens.padding, notificationTokens.textboxPaddingTopWithTopIcon, notificationTokens.contentPaddingTop, notificationTokens.contentPaddingRight, notificationTokens.contentPaddingBottom, notificationTokens.contentPaddingLeft, notificationTokens.buttonsMarginLeft)
    }
  }
};