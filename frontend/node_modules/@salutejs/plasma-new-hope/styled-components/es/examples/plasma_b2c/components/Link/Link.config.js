...
export var config = {
  ...
  variations: {
    ...
    disabled: {
      "true": /*#__PURE__*/css(["--plasma-link-disabled-opacity:0.4;"])
    },
    focused: {
      "true": /*#__PURE__*/css(["--plasma-link-focus-color:var(--text-accent);"])
    }
  }
};