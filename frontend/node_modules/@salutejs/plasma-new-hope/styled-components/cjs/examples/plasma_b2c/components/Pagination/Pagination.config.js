...
var config = exports.config = {
  ...
  variations: {
    view: {
      secondary: /*#__PURE__*/(0, _styledComponents.css)(["", ":var(--text-primary);", ":var(--surface-transparent-secondary);", ":var(--text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-transparent-secondary) 85% );", ":var(--text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-transparent-secondary) 80% );", ":0.4;", ":var(--surface-transparent-secondary);", ":var(--surface-solid-secondary);", ":transparent;", ":var(--text-primary);", ":var(--surface-accent);"], _Pagination.paginationTokens.buttonColor, _Pagination.paginationTokens.buttonBackgroundColor, _Pagination.paginationTokens.buttonHoverColor, _Pagination.paginationTokens.buttonHoverBackgroundColor, _Pagination.paginationTokens.buttonActiveColor, _Pagination.paginationTokens.buttonActiveBackgroundColor, _Pagination.paginationTokens.buttonDisabledOpacity, _Pagination.paginationTokens.inputBackgroundColor, _Pagination.paginationTokens.selectBackgroundColor, _Pagination.paginationTokens.inputBorderColor, _Pagination.paginationTokens.paginationColor, _Pagination.paginationTokens.buttonFocusColor),
      clear: /*#__PURE__*/(0, _styledComponents.css)(["", ":var(--text-primary);", ":var(--surface-clear);", ":var(--text-primary);", ":color-mix(in srgb,var(--text-primary),var(--surface-clear) 95%);", ":var(--text-primary);", ":color-mix(in srgb,var(--text-primary),var(--surface-clear) 90%);", ":0.4;", ":var(--surface-transparent-secondary);", ":var(--surface-solid-card);", ":transparent;", ":var(--text-primary);", ":var(--surface-accent);"], _Pagination.paginationTokens.buttonColor, _Pagination.paginationTokens.buttonBackgroundColor, _Pagination.paginationTokens.buttonHoverColor, _Pagination.paginationTokens.buttonHoverBackgroundColor, _Pagination.paginationTokens.buttonActiveColor, _Pagination.paginationTokens.buttonActiveBackgroundColor, _Pagination.paginationTokens.buttonDisabledOpacity, _Pagination.paginationTokens.inputBackgroundColor, _Pagination.paginationTokens.selectBackgroundColor, _Pagination.paginationTokens.inputBorderColor, _Pagination.paginationTokens.paginationColor, _Pagination.paginationTokens.buttonFocusColor),
      "default": /*#__PURE__*/(0, _styledComponents.css)(["", ":var(--inverse-text-primary);", ":var(--surface-solid-default);", ":var(--inverse-text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-solid-default) 85% );", ":var(--inverse-text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-solid-default) 80% );", ":0.4;", ":var(--surface-transparent-secondary);", ":transparent;", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-solid-default) 85% );", ":var(--text-primary);", ":var(--surface-accent);"], _Pagination.paginationTokens.buttonColor, _Pagination.paginationTokens.buttonBackgroundColor, _Pagination.paginationTokens.buttonHoverColor, _Pagination.paginationTokens.buttonHoverBackgroundColor, _Pagination.paginationTokens.buttonActiveColor, _Pagination.paginationTokens.buttonActiveBackgroundColor, _Pagination.paginationTokens.buttonDisabledOpacity, _Pagination.paginationTokens.inputBackgroundColor, _Pagination.paginationTokens.inputBorderColor, _Pagination.paginationTokens.selectBackgroundColor, _Pagination.paginationTokens.paginationColor, _Pagination.paginationTokens.buttonFocusColor)
    },
    viewCurrentPage: {
      "default": /*#__PURE__*/(0, _styledComponents.css)(["", ":var(--inverse-text-primary);", ":var(--surface-solid-default);", ":var(--inverse-text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-solid-default) 85% );", ":var(--inverse-text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-solid-default) 80% );"], _Pagination.paginationTokens.paginationCurrentButtonColor, _Pagination.paginationTokens.paginationCurrentButtonBackgroundColor, _Pagination.paginationTokens.paginationCurrentButtonHoverColor, _Pagination.paginationTokens.paginationCurrentButtonHoverBackgroundColor, _Pagination.paginationTokens.paginationCurrentButtonActiveColor, _Pagination.paginationTokens.paginationCurrentButtonActiveBackgroundColor),
      secondary: /*#__PURE__*/(0, _styledComponents.css)(["", ":var(--text-primary);", ":var(--surface-transparent-secondary);", ":var(--text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-transparent-secondary) 85% );", ":var(--text-primary);", ":color-mix( in srgb,var(--inverse-text-primary),var(--surface-transparent-secondary) 80% );"], _Pagination.paginationTokens.paginationCurrentButtonColor, _Pagination.paginationTokens.paginationCurrentButtonBackgroundColor, _Pagination.paginationTokens.paginationCurrentButtonHoverColor, _Pagination.paginationTokens.paginationCurrentButtonHoverBackgroundColor, _Pagination.paginationTokens.paginationCurrentButtonActiveColor, _Pagination.paginationTokens.paginationCurrentButtonActiveBackgroundColor),
