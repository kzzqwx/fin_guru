...
exports.getSkeletonColor = exports.applySkeletonGradient = void 0;
/**
 ...
 */
var getSkeletonColor = exports.getSkeletonColor = function getSkeletonColor(_ref) {
 ...
 */
var applySkeletonGradient = exports.applySkeletonGradient = function applySkeletonGradient(gradientColor) {
  return "\n    position: relative;\n    overflow: hidden;\n    z-index: 1; /* for safari */\n\n    &::before {\n        content: '';\n        position: absolute;\n        top: 0;\n        left: -100vw;\n        width: 200vw;\n        height: 100%;\n        animation: loading 4s linear infinite;\n        background-image: ".concat(gradientColor, ";\n    }\n\n    @keyframes loading {\n        from {\n            transform: translateX(0);\n        }\n\n        to {\n            transform: translateX(100vw);\n        }\n    }\n");
};