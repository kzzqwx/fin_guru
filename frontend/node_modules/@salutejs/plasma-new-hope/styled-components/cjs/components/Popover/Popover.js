 ...
 */
var popoverRoot = exports.popoverRoot = function popoverRoot(Root) {
  return /*#__PURE__*/(0, _react.forwardRef)(function (_ref, outerRootRef) {
    ...
    return /*#__PURE__*/_react["default"].createElement(_Popover.StyledWrapper, {
      className: _Popover2.classes.wrapper,
      ...
      className: _Popover2.classes.root,
      ref: popoverForkRef,
      style: _objectSpread(_objectSpread(_objectSpread({}, styles.popper), {
        display: isOpen ? 'block' : 'none'
      }), initialStyles),
      zIndex: zIndex
    }), hasArrow && /*#__PURE__*/_react["default"].createElement(_Popover.StyledArrow, _extends({
