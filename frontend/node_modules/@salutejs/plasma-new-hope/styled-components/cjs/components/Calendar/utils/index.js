...
exports.isValueUpdate = exports.isSelectedYear = exports.isSelectedMonth = exports.isSelectedDay = exports.isSelectProcess = exports.isSameDay = exports.isDayInRange = exports.isCurrentYear = exports.isCurrentMonth = exports.getStartYear = exports.getSortedValues = exports.getSideInRange = exports.getSideForSelected = exports.getSideForHovered = exports.getPrevDate = exports.getOffsetDayInWeek = exports.getNextDate = exports.getMatrix = exports.getInRange = exports.getDaysInMonth = exports.getDateFromValue = exports.getDateFromNow = exports.getCalendarType = exports.canSelectDate = exports.YEAR_RENDER_COUNT = exports.SHORT_MONTH_NAME = exports.SHORT_DAY_NAMES = exports.ROW_STEP = exports.MONTH_NAMES = exports.IsCurrentDay = exports.FULL_DAY_NAMES = void 0;
...
var YEAR_RENDER_COUNT = exports.YEAR_RENDER_COUNT = 12;
...
var getDaysInMonth = exports.getDaysInMonth = function getDaysInMonth(monthIndex, year) {
  return new Date(year, monthIndex + 1, 0).getDate();
};
var getOffsetDayInWeek = exports.getOffsetDayInWeek = function getOffsetDayInWeek(monthIndex, year) {
  return (new Date(year, monthIndex).getDay() || 7) - 1;
};
var getStartYear = exports.getStartYear = function getStartYear(year) {
  return Math.trunc((year - 1) * 0.1) * 10 - 1;
};
var getNextDate = exports.getNextDate = function getNextDate(currentYear, currentMonth) {
  return currentMonth + 1 === MONTH_NAMES.length ? [currentYear + 1, 0] : [currentYear, currentMonth + 1];
};
var getPrevDate = exports.getPrevDate = function getPrevDate(currentYear, currentMonth) {
  return currentMonth - 1 < 0 ? [currentYear - 1, 11] : [currentYear, currentMonth - 1];
};
var getDateFromValue = exports.getDateFromValue = function getDateFromValue(date) {
...
var getDateFromNow = exports.getDateFromNow = function getDateFromNow() {
...
var IsCurrentDay = exports.IsCurrentDay = function IsCurrentDay(date, currentDay) {
...
var isSelectedDay = exports.isSelectedDay = function isSelectedDay(date, currentDay, value) {
  if (!value) {
    return false;
  }
...
var isCurrentMonth = exports.isCurrentMonth = function isCurrentMonth(date, monthIndex) {
...
var isSelectedMonth = exports.isSelectedMonth = function isSelectedMonth(date, monthIndex) {
...
var isSelectedYear = exports.isSelectedYear = function isSelectedYear(date, year) {
  return date.year === year;
};
var getSortedValues = exports.getSortedValues = function getSortedValues(values) {
...
var isDayInRange = exports.isDayInRange = function isDayInRange(year, monthIndex, currentDay, values) {
...
var isSameDay = exports.isSameDay = function isSameDay(firstDate, secondDate) {
  return secondDate && firstDate.day === secondDate.day && firstDate.monthIndex === secondDate.monthIndex && firstDate.year === secondDate.year;
};
var isValueUpdate = exports.isValueUpdate = function isValueUpdate(value, prevValue) {
 ...
 */
var isSelectProcess = exports.isSelectProcess = function isSelectProcess(array) {
 ...
 */
var getSideForSelected = exports.getSideForSelected = function getSideForSelected(date, startValue, endValue) {
 ...
 */
var getSideForHovered = exports.getSideForHovered = function getSideForHovered(date, hoveredDay, startValue, isSelected) {
 ...
 */
var getSideInRange = exports.getSideInRange = function getSideInRange(value, date, hoveredDay, isSelected) {
 ...
 */
var getInRange = exports.getInRange = function getInRange(value, date, hoveredDay, inRange) {
 ...
 */
var canSelectDate = exports.canSelectDate = function canSelectDate(_ref, value, disabledList) {
  var year = _ref.year,
 ...
 */
var getMatrix = exports.getMatrix = function getMatrix(items) {
...
var getCalendarType = exports.getCalendarType = function getCalendarType(type) {
  switch (type) {
    case 'Months':
      return 'год';
    case 'Years':
