...
var updatePropsRecursively = function updatePropsRecursively(children, externalProps, value, search, filterFunction) {
  return React.Children.map(children || [], function (child) {
    ...
    if (filterFunction) {
      ...
      return filterFunction(text, search) ? /*#__PURE__*/React.cloneElement(child, props, updatedChild) : null;
    }
    return /*#__PURE__*/React.cloneElement(child, props, updatedChild);
  });
};
...
exports.getNewSelected = getNewSelected;
