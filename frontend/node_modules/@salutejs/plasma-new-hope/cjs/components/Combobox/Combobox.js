...
var index$2 = require('../Dropdown/utils/index.js');
var index = require('../Select/utils/index.js');
...
var comboboxRoot = function comboboxRoot(Root) {
  return /*#__PURE__*/React.forwardRef(function (_ref, outerRootRef) {
    ...
    var handleRef = plasmaCore.useForkRef(targetRef, outerRootRef);
    var controlledRefs = {
      targetRef: targetRef,
      chipsRefs: chipsRefs,
    ...
    var closedWithoutChanges = React.useRef(true);
    ...
    return /*#__PURE__*/React.createElement(Combobox_styles.StyledRoot, {
      ref: comboboxRef
    }, /*#__PURE__*/React.createElement(Combobox_styles.StyledNativeSelect, {
      "aria-invalid": "false",
      "aria-hidden": "true",
    ...
    }), /*#__PURE__*/React.createElement(Combobox_styles.StyledPopover, {
      role: role,
      isOpen: innerOpened,
      onToggle: onInnerToggle,
      target: /*#__PURE__*/React.createElement(ComboboxTarget.ComboboxTarget, _rollupPluginBabelHelpers.extends({
        opened: innerOpened,
        values: values,
        label: label,
      ...
      className: index$1.cx(ref === null || ref === void 0 ? void 0 : ref.classList.toString()) // INFO: Прокидываем стили для Popover
      ,
      id: innerId,
      offset: offset,
      placement: index$2.getPlacements(placement),
      usePortal: usePortal,
      ...
      view: view,
      size: size
    }, /*#__PURE__*/React.createElement(Combobox_styles.StyledCombobox, {
      onKeyDown: onKeyDownSelect
    }, childrenMemo.length ? childrenMemo : /*#__PURE__*/React.createElement(Combobox_styles.ComboboxItemNotFound, null, negativeResultContent)))));
  });
};
var comboboxConfig = {
  name: 'Combobox',
...
exports.comboboxConfig = comboboxConfig;
