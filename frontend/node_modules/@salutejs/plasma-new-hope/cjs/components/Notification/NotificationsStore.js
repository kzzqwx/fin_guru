 ...
 */
var NotificationsStore = /*#__PURE__*/storeon.createStoreon([function (store) {
  ...
  store.on('hide', function (_ref2, id) {
    ...
    return {
      notifications: notifications.map(function (notif) {
        return id === notif.id ? _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, notif), {}, {
          isHidden: true
        }) : notif;
      })
    };
...
function addNotification(_ref4) {
  ...
  var dispatch = NotificationsStore.dispatch;
  dispatch('add', _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, rest), {}, {
    id: id,
    isHidden: false
  }));
  setTimeout(function () {
