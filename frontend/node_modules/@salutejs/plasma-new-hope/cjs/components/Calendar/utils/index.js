...
var getSideInRange = function getSideInRange(value, date, hoveredDay, isSelected) {
  ...
  var _value = _rollupPluginBabelHelpers.slicedToArray(value, 2),
    startValue = _value[0],
    endValue = _value[1];
...
var canSelectDate = function canSelectDate(_ref, value, disabledList) {
  ...
  var _value2 = _rollupPluginBabelHelpers.slicedToArray(value, 1),
    startDate = _value2[0];
...
var getMatrix = function getMatrix(items) {
  ...
  var newItems = _rollupPluginBabelHelpers.toConsumableArray(items);
  var selected;
