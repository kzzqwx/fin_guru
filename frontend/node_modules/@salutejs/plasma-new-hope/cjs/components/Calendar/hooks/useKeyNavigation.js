...
var Calendar_types = require('../Calendar.types.js');
...
var getDoubleCalendarSide = function getDoubleCalendarSide(currentIndexWeek) {
  if (currentIndexWeek >= 0 && currentIndexWeek < index.ROW_STEP) {
    return 'first';
  }
  if (currentIndexWeek >= index.ROW_STEP && currentIndexWeek < index.ROW_STEP * 2) {
    return 'second';
  }
  return '';
};
...
var hasDisabledArrowKey = function hasDisabledArrowKey(_ref3) {
  ...
  var refs = _ref3.refs,
    ...
    key = _ref3.key;
  var _payload = _rollupPluginBabelHelpers.slicedToArray(payload, 2),
...
var useKeyNavigation = function useKeyNavigation(_ref10) {
  ...
  var _size = _rollupPluginBabelHelpers.slicedToArray(size, 2),
    rowSize = _size[0],
    columnSize = _size[1];
  ...
  var withShiftState = React.useRef(false);
  var currentIndexes = React.useRef([0, 0]);
  var outerRefs = React.useRef(Array(rowSize + 1).fill(0).map(function () {
  ...
  React.useLayoutEffect(function () {
    ...
    var _getCorrectIndexes = getCorrectIndexes(outerRefs, selectIndexes, rowSize, columnSize, withShiftState.current, currentIndexes.current),
      _getCorrectIndexes2 = _rollupPluginBabelHelpers.slicedToArray(_getCorrectIndexes, 2),
  ...
  React.useLayoutEffect(function () {
    ...
    var _selectIndexes = _rollupPluginBabelHelpers.slicedToArray(selectIndexes, 2),
  ...
  var onKeyDown = React.useCallback(function (event) {
    ...
    var _selectIndexes2 = _rollupPluginBabelHelpers.slicedToArray(selectIndexes, 2),
    ...
    switch (keyCode) {
      case Calendar_types.Keys.pageUp:
        {
          var isDisabledPreviousMonth = hasDisabledMonths({
      ...
      case Calendar_types.Keys.pageDown:
        {
          var isDisabledNextMonth = hasDisabledMonths({
            item: outerRefs.current[currentRowIndex][currentColumnIndex],
            key: 'next'
      ...
      case Calendar_types.Keys.left:
        {
          ...
          if (withShift) {
            var _getPreviousCorrectPo = getPreviousCorrectPosition(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
              _getPreviousCorrectPo2 = _rollupPluginBabelHelpers.slicedToArray(_getPreviousCorrectPo, 2),
      ...
      case Calendar_types.Keys.up:
        {
          ...
          if (withShift) {
            ...
            var _getPreviousCorrectPo3 = getPreviousCorrectPosition(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
              _getPreviousCorrectPo4 = _rollupPluginBabelHelpers.slicedToArray(_getPreviousCorrectPo3, 2),
      ...
      case Calendar_types.Keys.right:
        {
          ...
          if (withShift) {
            var _getNextCorrectPositi = getNextCorrectPosition(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
              _getNextCorrectPositi2 = _rollupPluginBabelHelpers.slicedToArray(_getNextCorrectPositi, 2),
      ...
      case Calendar_types.Keys.down:
        {
          ...
          if (withShift) {
            ...
            var _getNextCorrectPositi3 = getNextCorrectPosition(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
              _getNextCorrectPositi4 = _rollupPluginBabelHelpers.slicedToArray(_getNextCorrectPositi3, 2),
      ...
      case Calendar_types.Keys.enter:
      case Calendar_types.Keys.space:
        {
