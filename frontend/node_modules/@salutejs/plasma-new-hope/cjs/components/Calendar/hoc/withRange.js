...
var withRange = function withRange(Component) {
  return function (_ref) {
    ...
    var _useState = React.useState([startExternalValue, endExternalValue]),
      _useState2 = _rollupPluginBabelHelpers.slicedToArray(_useState, 2),
      _useState2$ = _rollupPluginBabelHelpers.slicedToArray(_useState2[0], 2),
    ...
    if (index.isValueUpdate(value, prevValue)) {
      setValues([startExternalValue, endExternalValue]);
      setPrevValue(value);
    }
    var handleOnChangeDay = React.useCallback(function (newDay) {
      if (endValue) {
      ...
      var _getSortedValues = index.getSortedValues([startValue, newDay]),
    ...
    return /*#__PURE__*/React.createElement(Component, _rollupPluginBabelHelpers.extends({
