...
export declare type DrawerPlacement = keyof typeof drawerPlacements;
export declare type DrawerProps = PopupProps & PanelProps & {
    /**
     * Расположение Drawer.
     * @default
     * left
...
export interface DrawerHookArgs extends Pick<PopupHookArgs, 'id' | 'popupInfo' | 'isOpen'>, Pick<DrawerProps, 'closeOnEsc' | 'onEscKeyDown' | 'onClose'> {
