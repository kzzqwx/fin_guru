...
export declare type ComponentVariation = {
...
export declare type CalendarProps = BaseProps | BaseRangeProps | DoubleProps | DoubleRangeProps;
export {};
