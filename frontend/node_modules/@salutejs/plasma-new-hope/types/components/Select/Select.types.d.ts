...
export declare type ValueType = 'single' | 'multiple' | 'native';
export declare type EnumerationType = 'comma' | 'chip';
export declare type TargetType = 'button-like' | 'textField-like';
...
export declare type valueTypeSeparation = {
    /**
     * Тип селекта.
...
export declare type SelectProps = Omit<InputHTMLAttributes<HTMLSelectElement>, 'value' | 'size' | 'onChange'> & CustomSelectProps & valueTypeSeparation;
