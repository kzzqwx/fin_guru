...
export interface SelectChipProps {
     ...
     */
    onKeyDown?: (value: SelectPrimitiveValue, text: SelectPrimitiveValue, index: number, event: KeyboardEvent<HTMLButtonElement>) => void;
}
//# sourceMappingURL=SelectChip.types.d.ts.map