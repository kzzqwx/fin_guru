export declare const classes: {
    selectTarget: string;
    selectTargeText: string;
    selectTargetLabel: string;
    selectTargetArrow: string;
    arrowInverse: string;
    selectItemIsSelected: string;
    selectItemIsDisabled: string;
    nativeSelectVisible: string;
    hasNoFocus: string;
    hasChips: string;
    innerLabelUp: string;
};
...
//# sourceMappingURL=Select.tokens.d.ts.map