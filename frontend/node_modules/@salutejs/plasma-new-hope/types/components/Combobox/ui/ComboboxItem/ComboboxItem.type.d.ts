...
declare type ComboboxItemCustomProps = {
    /**
...
export declare type ComboboxItemProps = Omit<HTMLAttributes<HTMLDivElement>, 'onSelect'> & ComboboxItemCustomProps;
export {};
//# sourceMappingURL=ComboboxItem.type.d.ts.map