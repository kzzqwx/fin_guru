...
export declare type ComboboxPrimitiveValue = string | number | boolean;
export declare type ComboboxValue = ComboboxPrimitiveValue | Array<ComboboxPrimitiveValue>;
export declare type ValueType = 'single' | 'multiple';
export declare type EnumerationType = 'comma' | 'chip';
...
export declare type ComboboxTypeSeparation = {
    /**
     * Тип комбобокса.
...
export declare type ComboboxProps = Omit<InputHTMLAttributes<HTMLInputElement>, 'value' | 'size' | 'target' | 'checked' | 'type' | 'maxLength' | 'minLength' | 'onChange'> & CustomComboboxProps & ComboboxTypeSeparation;
