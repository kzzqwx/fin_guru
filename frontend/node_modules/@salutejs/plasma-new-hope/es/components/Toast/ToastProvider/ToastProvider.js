...
var ToastProviderHoc = function ToastProviderHoc(ToastComponent) {
  return function ToastProvider(_ref) {
    ...
    var animationRunTimeout = useRef(null);
    var _useState5 = useState(initialToastData),
    ...
    var showToastCallback = function showToastCallback() {
      ...
      var _getShowToastCallSign = getShowToastCallSignature(args),
        ...
        fade = _getShowToastCallSign3 === void 0 ? DEFAULT_FADE : _getShowToastCallSign3,
...
export { ToastContext, ToastProviderHoc, useToast, useToastInner };
