...
import { classes, tokens } from '../Grid.tokens.js';
...
var getColLegacyTokens = function getColLegacyTokens(props) {
  return Object.entries(legacyGridSizesMap).reduce(function (acc, _ref) {
    ...
    return _objectSpread2(_objectSpread2({}, acc), {}, _defineProperty(_defineProperty({}, "--plasma_private-grid-col-".concat(gridSize, "-size"), size), "--plasma_private-grid-col-".concat(gridSize, "-offset"), offset));
  }, {});
};
...
var getColTokens = function getColTokens(props) {
  ...
  return gridSizes.reduce(function (acc, size) {
    ...
    return _objectSpread2(_objectSpread2({}, acc), {}, _defineProperty(_defineProperty({}, "--plasma_private-grid-col-".concat(size, "-size"), (_props$size = props[size]) === null || _props$size === void 0 ? void 0 : _props$size.size), "--plasma_private-grid-col-".concat(size, "-offset"), (_props$size2 = props[size]) === null || _props$size2 === void 0 ? void 0 : _props$size2.offset));
  }, {});
};

export { getBaseGridView, getColTokens, getGridViewClass, gridSizes };
