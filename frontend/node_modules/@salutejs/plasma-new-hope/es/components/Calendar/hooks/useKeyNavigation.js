...
import { Keys } from '../Calendar.types.js';
import { ROW_STEP } from '../utils/index.js';
      ...
      case Keys.left:
        {
          ...
          if (withShift) {
            var _getPreviousCorrectPo = getPreviousCorrectPosition(_objectSpread2(_objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
      ...
      case Keys.up:
        {
          ...
          if (withShift) {
            ...
            var _getPreviousCorrectPo3 = getPreviousCorrectPosition(_objectSpread2(_objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
      ...
      case Keys.right:
        {
          ...
          if (withShift) {
            var _getNextCorrectPositi = getNextCorrectPosition(_objectSpread2(_objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
      ...
      case Keys.down:
        {
          ...
          if (withShift) {
            ...
            var _getNextCorrectPositi3 = getNextCorrectPosition(_objectSpread2(_objectSpread2({}, positionState), {}, {
                newRowIndex: newRowIndex,
                newColumnIndex: newColumnIndex
              })),
