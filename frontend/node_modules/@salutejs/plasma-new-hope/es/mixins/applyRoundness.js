 ...
 */
var getRoundness = function getRoundness(_ref) {
  var roundness = _ref.roundness;
  if (!Number.isNaN(Number(roundness))) {
    return "".concat(radiuses[roundness], "rem");
  }
 ...
 */
var applyRoundness = function applyRoundness(roundness) {
  return "\n            border-radius: ".concat(roundness, ";\n        ");
};

export { applyRoundness, getRoundness, radiuses };
