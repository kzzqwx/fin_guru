...
var spacing = /*#__PURE__*/_objectSpread2( /*#__PURE__*/_objectSpread2({}, baseSpacing), {}, {
  '0x': baseSpacing[0],
  '1x': baseSpacing[2],
  '2x': baseSpacing[4],
  '4x': baseSpacing[8],
...
var createSpacingFn = function createSpacingFn(params) {
  return function (value) {
    return params.reduce(function (acc, cur) {
      return _objectSpread2(_objectSpread2({}, acc), {}, _defineProperty({}, cur, spacing[value]));
    }, {});
  };
};
...
var applySpacing = function applySpacing(props) {
  return spacingFnsList.reduce(function (styles, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      ...
      fn = _ref2[1];
    if (fnName in props) {
      return _objectSpread2(_objectSpread2({}, styles), fn(props[fnName]));
    }
    return styles;
  }, {});
};

export { applySpacing, spacing, spacingFns };
