...
export var dark = {
    ":root": {
        "--plasma-colors-white": "rgba(255, 255, 255, 0.96)",
        ...
        "--plasma-colors-link-hover": "#6298FD",
        "--plasma-colors-link-active": "#1767FD",
        "--plasma-colors-link-visited": "#5993FF",
        "--plasma-colors-link-visited-hover": "#7DAAFF",
        "--plasma-colors-link-visited-active": "#3078FF",
        ...
        "--plasma-colors-input-border": "rgba(0, 0, 0, 0)",
        "--plasma-colors-input-border-hover": "rgba(0, 0, 0, 0)",
        "--plasma-colors-input-border-focus": "rgba(0, 0, 0, 0)",
        "--plasma-colors-input-error-background": "rgba(255, 46, 67, 0.12)",
        ...
        "--plasma-colors-button-primary": "#3F82FD",
        "--plasma-colors-button-primary-hover": "#538efe",
        "--plasma-colors-button-primary-active": "#3a75e5",
        "--plasma-colors-button-secondary": "rgba(255, 255, 255, 0.12)",
        "--plasma-colors-button-secondary-hover": "rgba(255, 255, 255, 0.16)",
        "--plasma-colors-button-secondary-active": "rgba(255, 255, 255, 0.1)",
        "--plasma-colors-button-accent": "#3F82FD",
        "--plasma-colors-button-success": "#21A038",
        "--plasma-colors-button-success-transparent": "rgba(33, 160, 56, 0.3)",
        "--plasma-colors-button-success-hover": "#3eaa4d",
        "--plasma-colors-button-success-active": "#1d9233",
        "--plasma-colors-button-success-active-transparent": "rgba(97, 181, 103, 0.384)",
        "--plasma-colors-button-warning": "#E35502",
        "--plasma-colors-button-warning-transparent": "rgba(227, 85, 2, 0.3)",
        "--plasma-colors-button-warning-hover": "#f76d2f",
        "--plasma-colors-button-warning-active": "#de550a",
        "--plasma-colors-button-warning-active-transparent": "rgba(238, 127, 83, 0.384)",
        "--plasma-colors-button-critical": "#FF2E43",
        "--plasma-colors-button-critical-transparent": "rgba(255, 46, 67, 0.3)",
        "--plasma-colors-button-critical-hover": "#ff4757",
        "--plasma-colors-button-critical-active": "#e82a3e",
        "--plasma-colors-button-critical-active-transparent": "rgba(255, 114, 113, 0.384)",
        "--plasma-colors-button-checked": "#FFFFFF",
        "--plasma-colors-button-checked-hover": "#FFFFFF",
        "--plasma-colors-button-checked-hover-color": "hsla(0, 0%, 3.1372549019607843%, 1)",
        "--plasma-colors-button-checked-active": "#FFFFFF",
        "--plasma-colors-button-checked-active-color": "hsla(0, 0%, 3.1372549019607843%, 1)",
        "--plasma-colors-button-focused": "#3F82FD",
        ...
        "--plasma-colors-skeleton-gradient": "linear-gradient( 90deg, rgba(255, 255, 255, 0.09) 0%, rgba(255, 255, 255, 0.08) 6.25%, rgba(255, 255, 255, 0.05) 12.5%, rgba(255, 255, 255, 0.01) 25%, rgba(255, 255, 255, 0.05) 37.5%, rgba(255, 255, 255, 0.08) 43.75%, rgba(255, 255, 255, 0.09) 50%, rgba(255, 255, 255, 0.08) 56.25%, rgba(255, 255, 255, 0.05) 62.5%, rgba(255, 255, 255, 0.01) 75%, rgba(255, 255, 255, 0.05) 87.5%, rgba(255, 255, 255, 0.08) 93.75%, rgba(255, 255, 255, 0.09) 100% )",
        "--plasma-colors-skeleton-gradient-lighter": "linear-gradient( 90deg, rgba(255, 255, 255, 0.36) 0%, rgba(255, 255, 255, 0.32) 6.25%, rgba(255, 255, 255, 0.20) 12.5%, rgba(255, 255, 255, 0.04) 25%, rgba(255, 255, 255, 0.20) 37.5%, rgba(255, 255, 255, 0.32) 43.75%, rgba(255, 255, 255, 0.36) 50%, rgba(255, 255, 255, 0.08) 56.25%, rgba(255, 255, 255, 0.20) 62.5%, rgba(255, 255, 255, 0.04) 75%, rgba(255, 255, 255, 0.20) 87.5%, rgba(255, 255, 255, 0.32) 93.75%, rgba(255, 255, 255, 0.36) 100% )",
        "--plasma-colors-speech-bubble-sent": "",
        "--plasma-colors-speech-bubble-received": "",
        ...
        "--plasma-outline-size": "0.125rem",
        "--plasma-button-l-height": "3.5rem",
        "--plasma-button-l-padding-y": "1rem",
        "--plasma-button-l-padding-x": "1.625rem",
        "--plasma-button-l-padding-content-x": "1.625rem",
        "--plasma-button-l-padding-stretch-x": "1.25rem",
        "--plasma-button-l-radius": "1rem",
        "--plasma-button-l-radius-circle": "1.75rem",
        "--plasma-button-m-height": "3rem",
        "--plasma-button-m-padding-y": "0.75rem",
        "--plasma-button-m-padding-x": "1.375rem",
        "--plasma-button-m-padding-content-x": "1.5rem",
        "--plasma-button-m-padding-stretch-x": "1.25rem",
        "--plasma-button-m-radius": "0.75rem",
        "--plasma-button-m-radius-circle": "1.5rem",
        "--plasma-button-s-height": "2.5rem",
        "--plasma-button-s-padding-y": "0.5rem",
        "--plasma-button-s-padding-x": "1.125rem",
        "--plasma-button-s-padding-content-x": "1.25rem",
        "--plasma-button-s-padding-stretch-x": "1.25rem",
        "--plasma-button-s-radius": "0.75rem",
        "--plasma-button-s-radius-circle": "1.25rem",
        "--plasma-field-helper-text-margin-top": "0.25rem",
        "--plasma-field-helper-text-font-family": "var(--plasma-typo-text-xs-font-family)",
        "--plasma-field-helper-text-font-size": "var(--plasma-typo-text-xs-font-size)",
        "--plasma-field-helper-text-font-style": "var(--plasma-typo-text-xs-font-style)",
        "--plasma-field-helper-text-font-weight": "var(--plasma-typo-text-xs-bold-font-weight)",
        "--plasma-field-helper-text-letter-spacing": "var(--plasma-typo-text-xs-letter-spacing)",
        "--plasma-field-helper-text-line-height": "var(--plasma-typo-text-xs-line-height)",
        "--plasma-field-label-margin-bottom": "0.75rem",
        "--plasma-field-label-color": "var(--plasma-colors-primary)",
        "--plasma-field-content-margin": "1rem",
        "--plasma-input-border-width": "1px",
        "--plasma-input-border-radius": "0.75rem",
        "--plasma-input-l-height": "3rem",
        "--plasma-input-l-padding-y": "0.75rem",
        "--plasma-input-l-padding-x": "1rem",
        "--plasma-input-l-has-label-padding-top": "1.4375rem",
        "--plasma-input-l-has-label-padding-bottom": "0.4375rem",
        "--plasma-input-l-has-content-padding-left": "3.25rem",
        "--plasma-input-l-has-content-padding-right": "3.25rem",
        "--plasma-input-m-height": "2.5rem",
        "--plasma-input-m-padding-y": "0.5rem",
        "--plasma-input-m-padding-x": "1rem",
        "--plasma-input-m-has-content-padding-left": "3.25rem",
        "--plasma-input-m-has-content-padding-right": "3.25rem",
        "--plasma-input-s-height": "2rem",
        "--plasma-input-s-padding-y": "0.25rem",
        "--plasma-input-s-padding-x": "1rem",
        "--plasma-input-s-has-content-padding-left": "3.25rem",
        "--plasma-input-s-has-content-padding-right": "3.25rem",
        "--plasma-input-font-family": "var(--plasma-typo-body-s-font-family)",
        "--plasma-input-font-size": "var(--plasma-typo-body-s-font-size)",
        "--plasma-input-font-style": "var(--plasma-typo-body-s-font-style)",
        "--plasma-input-font-weight": "var(--plasma-typo-body-s-bold-font-weight)",
        "--plasma-input-letter-spacing": "var(--plasma-typo-body-s-letter-spacing)",
        "--plasma-input-line-height": "var(--plasma-typo-body-s-line-height)",
        "--plasma-input-background-color": "var(--plasma-colors-surface-liquid01)",
        "--plasma-input-color": "var(--plasma-colors-primary)",
        "--plasma-input-caret-color": "var(--plasma-colors-primary)",
        "--plasma-input-placeholder-color": "var(--plasma-colors-secondary)",
        "--plasma-input-hover-background-color": "var(--plasma-colors-surface-liquid02)",
        "--plasma-input-focus-background-color": "var(--plasma-colors-surface-liquid02)",
        "--plasma-input-success-background-color": "var(--plasma-colors-background)",
        "--plasma-input-success-color": "var(--plasma-colors-primary)",
        "--plasma-input-success-border-color": "var(--plasma-colors-success)",
        "--plasma-input-warning-background-color": "var(--plasma-colors-background)",
        "--plasma-input-warning-color": "var(--plasma-colors-primary)",
        "--plasma-input-warning-border-color": "var(--plasma-colors-warning)",
        "--plasma-input-error-background-color": "var(--plasma-colors-input-error-background)",
        "--plasma-input-error-color": "var(--plasma-colors-critical)",
        "--plasma-input-error-border-color": "var(--plasma-colors-input-error-border)",
        "--plasma-input-focus-placeholder-color": "var(--plasma-colors-tertiary)",
        "--plasma-input-label-margin-top": "0.4375rem",
        "--plasma-input-label-font-family": "var(--plasma-typo-body-xxs-font-family)",
        "--plasma-input-label-font-size": "var(--plasma-typo-body-xxs-font-size)",
        "--plasma-input-label-font-style": "var(--plasma-typo-body-xxs-font-style)",
        "--plasma-input-label-font-weight": "var(--plasma-typo-body-xxs-bold-font-weight)",
        "--plasma-input-label-letter-spacing": "var(--plasma-typo-body-xxs-letter-spacing)",
        "--plasma-input-label-line-height": "var(--plasma-typo-body-xxs-line-height)",
        "--plasma-input-label-color": "var(--plasma-colors-tertiary)",
        "--plasma-field-font-family": "var(--plasma-typo-body-s-font-family)",
        "--plasma-field-font-size": "var(--plasma-typo-body-s-font-size)",
        "--plasma-field-font-style": "var(--plasma-typo-body-s-font-style)",
        "--plasma-field-font-weight": "var(--plasma-typo-body-s-bold-font-weight)",
        "--plasma-field-letter-spacing": "var(--plasma-typo-body-s-letter-spacing)",
        "--plasma-field-line-height": "var(--plasma-typo-body-s-line-height)",
