...
(0, _collectPackageInfo.collectPackageInfo)('Dropdown/DropdownPopup');
/**
 * Popup с внешним контролем над видимостью через props: `isOpen` и `onToggle`.
 */
var DropdownPopup = exports.DropdownPopup = /*#__PURE__*/(0, _styledComponents["default"])(_Popup.Popup).withConfig({
 ...
 */
var DropdownSelfControlledPopup = exports.DropdownSelfControlledPopup = function DropdownSelfControlledPopup(_ref2) {
