...
var _excluded = ["value", "items", "onChange", "design"];
 ...
 */
var withSingleSelect = exports.withSingleSelect = function withSingleSelect(View) {
  return /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(View, _extends({
      design: design,
      ref: ref,
      value: viewValue,
      items: viewItems,
