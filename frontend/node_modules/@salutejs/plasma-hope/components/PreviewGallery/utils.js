...
exports.noop = exports.arrayItemSwapping = exports.arrayItemSelecting = exports.arrayItemRemoving = void 0;
 ...
 * Метод-заглушка
 */
(0, _collectPackageInfo.collectPackageInfo)('PreviewGallery/utils');
 ...
 */
var arrayItemSwapping = exports.arrayItemSwapping = function arrayItemSwapping(oldItems, oldIndex, newIndex) {
 ...
 */
var arrayItemRemoving = exports.arrayItemRemoving = function arrayItemRemoving(oldItems, id) {
  if (!(oldItems !== null && oldItems !== void 0 && oldItems.length)) {
    return [];
  }
  var newItems = _toConsumableArray(oldItems);
 ...
 */
var arrayItemSelecting = exports.arrayItemSelecting = function arrayItemSelecting(oldItems, id) {
