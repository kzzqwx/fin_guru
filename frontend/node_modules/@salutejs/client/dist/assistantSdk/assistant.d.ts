...
export declare const createAssistant: ({ getMeta, getInitialMeta, getVoiceMeta, checkCertUrl, useVoiceAnalyser, ...configuration }: AssistantParams) => {
    ...
    readonly protocol: {
        ...
        getMessageId: () => Mid;
        sendCancel: (data: import("../proto").ICancel, last?: boolean, messageId?: Mid) => void; /** завершает текущий апп */
