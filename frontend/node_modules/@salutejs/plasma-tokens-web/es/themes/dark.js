...
export var dark = {
    ":root": {
        ...
        "--plasma-field-helper-text-font-family": "var(--plasma-typo-caption-font-family)",
        "--plasma-field-helper-text-font-weight": "var(--plasma-typo-caption-font-weight)",
        "--plasma-field-helper-text-font-style": "var(--plasma-typo-caption-font-style)",
        "--plasma-field-helper-text-font-size": "var(--plasma-typo-caption-font-size)",
        "--plasma-field-helper-text-letter-spacing": "var(--plasma-typo-caption-letter-spacing)",
        "--plasma-field-helper-text-line-height": "var(--plasma-typo-caption-line-height)",
        ...
        "--plasma-input-border-radius": "0.25rem",
        "--plasma-input-l-height": "3.5rem",
        "--plasma-input-l-padding-y": "1.125rem",
        "--plasma-input-l-padding-x": "1rem",
        "--plasma-input-l-has-label-padding-top": "1.5rem",
        "--plasma-input-l-has-label-padding-bottom": "0.375rem",
        "--plasma-input-l-has-content-padding-left": "3.125rem",
        "--plasma-input-l-has-content-padding-right": "3.125rem",
        "--plasma-input-m-height": "3rem",
        "--plasma-input-m-padding-y": "0.75rem",
        "--plasma-input-m-padding-x": "1rem",
        "--plasma-input-m-has-content-padding-left": "3.125rem",
        "--plasma-input-m-has-content-padding-right": "3.125rem",
        "--plasma-input-s-height": "2.5rem",
        "--plasma-input-s-padding-y": "0.5rem",
        "--plasma-input-s-padding-x": "1rem",
        "--plasma-input-s-has-content-padding-left": "3.125rem",
        "--plasma-input-s-has-content-padding-right": "3.125rem",
        "--plasma-input-font-family": "var(--plasma-typo-body1-font-family)",
        "--plasma-input-font-weight": "var(--plasma-typo-body1-font-weight)",
        "--plasma-input-font-style": "var(--plasma-typo-body1-font-style)",
        "--plasma-input-font-size": "var(--plasma-typo-body1-font-size)",
        "--plasma-input-letter-spacing": "var(--plasma-typo-body1-letter-spacing)",
        "--plasma-input-line-height": "var(--plasma-typo-body1-line-height)",
        ...
        "--plasma-input-placeholder-color": "var(--plasma-colors-tertiary)",
        ...
        "--plasma-input-label-font-family": "var(--plasma-typo-caption-font-family)",
        "--plasma-input-label-font-weight": "var(--plasma-typo-caption-font-weight)",
        "--plasma-input-label-font-style": "var(--plasma-typo-caption-font-style)",
        "--plasma-input-label-font-size": "var(--plasma-typo-caption-font-size)",
        "--plasma-input-label-letter-spacing": "var(--plasma-typo-caption-letter-spacing)",
        "--plasma-input-label-line-height": "var(--plasma-typo-caption-line-height)",
        "--plasma-field-font-family": "var(--plasma-typo-body1-font-family)",
        "--plasma-field-font-weight": "var(--plasma-typo-body1-font-weight)",
        "--plasma-field-font-style": "var(--plasma-typo-body1-font-style)",
        "--plasma-field-font-size": "var(--plasma-typo-body1-font-size)",
        "--plasma-field-letter-spacing": "var(--plasma-typo-body1-letter-spacing)",
        "--plasma-field-line-height": "var(--plasma-typo-body1-line-height)",
